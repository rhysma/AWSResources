...
namespace DyamoDB_WinForm
{
  public partial class Ddb_Intro
  {
    ...
    public const string partition_key_name = "ID";
    public const string sort_key_name      = "Name";
...
// movie_items_attributes
    public static List<AttributeDefinition> table_items_attributes
          = new List<AttributeDefinition>
        {
      new AttributeDefinition
      {
    ...
    public static List<KeySchemaElement> table_key_schema
  = new List<KeySchemaElement>
{
      new KeySchemaElement
      {
      ...
      = new ProvisionedThroughput( 1, 1 );
        ...
        public static ProvisionedThroughput provisioned_throughput
          = new ProvisionedThroughput(1, 1);
