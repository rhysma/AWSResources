...
1. Scenario 1
  1. Company A - Runs several production workloads within its datacenter. They use VMware to manage the infrastructure in the datacenter. They want to use AWS and integrate it in with their some of their datacenter workload (using the two in tandem). 
  1. Which cloud deployment model would this company be following? 
    1. Hybrid Cloud
 
1. Scenario 2
  1.  Company B - They are trying to decice whether to fund a new line of business and look at ways to monetize a new emerging technology. The new line of business will require some new infrastructure, beyond what they currently have. 
  1. What benefit of cloud computing would be most relevant to Company B?
    1. Pay as you go 
  
1. Scenario 3
  1. Company C - They have a new CTO at their insurance company. This is a medium-sized business.  They are considering moving to the cloud instead of colocating servers (which means they are renting space in another datacenter). They want to make sure they have the maximum control of their cloud servers and they want to that for security and compliance reasons. 
  1. In this case, what cloud computing model would they need to leverage? 
