...
Each instance of lambda is run in an ephemeral environment that is initialized on demand and then removed when it is finished. Lambda handles creating and removing these environments 
